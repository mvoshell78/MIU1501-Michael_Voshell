...
//@interface Voshell_Michael_UtilityAppObject : NSObject
//@end

@interface Voshell_Michael_UtilityAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Voshell_Michael_UtilityAppObject class]])
		{
			for (NSString *key in [[(Voshell_Michael_UtilityAppObject*)o modules] allKeys])
			{
