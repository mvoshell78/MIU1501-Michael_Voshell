 ...
 * to send analytic data that can be viewed on the Voshell_Michael_UtilityApp Dashboard.
 *
 * For information on getting started with Voshell_Michael_UtilityApp Platform Services,
