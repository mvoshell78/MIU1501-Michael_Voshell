...
/**
 Base class for all Voshell_Michael_UtilityApp views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Voshell_Michael_UtilityApp view hierarchy (such as wrapped iOS UIViews) was touched.
