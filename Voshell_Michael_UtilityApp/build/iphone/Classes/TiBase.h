...
// in simulator we redefine to format for Voshell_Michael_UtilityApp Developer console
...
{\
	NSString * exceptionName = [@"org.voshell_michael_utilityapp." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.voshell_michael_utilityapp";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIVoshell_Michael_UtilityAppNativeItemNone = -1, 
	UIVoshell_Michael_UtilityAppNativeItemSpinner = -2,
	UIVoshell_Michael_UtilityAppNativeItemProgressBar = -3,
	
	UIVoshell_Michael_UtilityAppNativeItemSlider = -4,
	UIVoshell_Michael_UtilityAppNativeItemSwitch = -5,
	UIVoshell_Michael_UtilityAppNativeItemMultiButton = -6,
	UIVoshell_Michael_UtilityAppNativeItemSegmented = -7,
	
	UIVoshell_Michael_UtilityAppNativeItemTextView = -8,
	UIVoshell_Michael_UtilityAppNativeItemTextField = -9,
	UIVoshell_Michael_UtilityAppNativeItemSearchBar = -10,
	
	UIVoshell_Michael_UtilityAppNativeItemPicker = -11,
	UIVoshell_Michael_UtilityAppNativeItemDatePicker = -12,
	
	UIVoshell_Michael_UtilityAppNativeItemInfoLight = -13,
	UIVoshell_Michael_UtilityAppNativeItemInfoDark = -14,
	
	UIVoshell_Michael_UtilityAppNativeItemDisclosure = -15,
	
	UIVoshell_Michael_UtilityAppNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Voshell_Michael_UtilityApp instances of
