...
@interface Voshell_Michael_UtilityAppObject : KrollCoverageObject {
#else
@interface Voshell_Michael_UtilityAppObject : KrollObject {
#endif
@private
...
extern NSString * Voshell_Michael_UtilityApp$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Voshell_Michael_UtilityAppObject *_voshell_michael_utilityapp;
    KrollObject* console;
	BOOL shutdown;
