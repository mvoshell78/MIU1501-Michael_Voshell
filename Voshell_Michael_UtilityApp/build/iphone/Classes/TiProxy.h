...
//Rare exceptions to indicate a bug in the _voshell_michael_utilityapp code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Voshell_Michael_UtilityApp proxies.
 */
