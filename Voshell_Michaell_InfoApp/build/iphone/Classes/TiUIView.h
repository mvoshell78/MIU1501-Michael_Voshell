...
/**
 Base class for all Voshell_Michaell_InfoApp views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Voshell_Michaell_InfoApp view hierarchy (such as wrapped iOS UIViews) was touched.
