...
//@interface Voshell_Michaell_InfoAppObject : NSObject
//@end

@interface Voshell_Michaell_InfoAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Voshell_Michaell_InfoAppObject class]])
		{
			for (NSString *key in [[(Voshell_Michaell_InfoAppObject*)o modules] allKeys])
			{
