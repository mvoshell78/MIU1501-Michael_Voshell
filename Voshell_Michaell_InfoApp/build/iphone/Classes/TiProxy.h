...
//Rare exceptions to indicate a bug in the _voshell_michaell_infoapp code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Voshell_Michaell_InfoApp proxies.
 */
