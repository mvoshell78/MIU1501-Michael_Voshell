...
@interface Voshell_Michaell_InfoAppObject : KrollCoverageObject {
#else
@interface Voshell_Michaell_InfoAppObject : KrollObject {
#endif
@private
...
extern NSString * Voshell_Michaell_InfoApp$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Voshell_Michaell_InfoAppObject *_voshell_michaell_infoapp;
    KrollObject* console;
	BOOL shutdown;
