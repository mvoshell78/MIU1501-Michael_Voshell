...
// in simulator we redefine to format for Voshell_Michaell_InfoApp Developer console
...
{\
	NSString * exceptionName = [@"org.voshell_michaell_infoapp." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.voshell_michaell_infoapp";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIVoshell_Michaell_InfoAppNativeItemNone = -1, 
	UIVoshell_Michaell_InfoAppNativeItemSpinner = -2,
	UIVoshell_Michaell_InfoAppNativeItemProgressBar = -3,
	
	UIVoshell_Michaell_InfoAppNativeItemSlider = -4,
	UIVoshell_Michaell_InfoAppNativeItemSwitch = -5,
	UIVoshell_Michaell_InfoAppNativeItemMultiButton = -6,
	UIVoshell_Michaell_InfoAppNativeItemSegmented = -7,
	
	UIVoshell_Michaell_InfoAppNativeItemTextView = -8,
	UIVoshell_Michaell_InfoAppNativeItemTextField = -9,
	UIVoshell_Michaell_InfoAppNativeItemSearchBar = -10,
	
	UIVoshell_Michaell_InfoAppNativeItemPicker = -11,
	UIVoshell_Michaell_InfoAppNativeItemDatePicker = -12,
	
	UIVoshell_Michaell_InfoAppNativeItemInfoLight = -13,
	UIVoshell_Michaell_InfoAppNativeItemInfoDark = -14,
	
	UIVoshell_Michaell_InfoAppNativeItemDisclosure = -15,
	
	UIVoshell_Michaell_InfoAppNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Voshell_Michaell_InfoApp instances of
