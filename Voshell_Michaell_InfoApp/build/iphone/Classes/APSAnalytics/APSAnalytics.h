 ...
 * to send analytic data that can be viewed on the Voshell_Michaell_InfoApp Dashboard.
 *
 * For information on getting started with Voshell_Michaell_InfoApp Platform Services,
